...
queries = {}
queries['liquidity4b_liq'] = [[p_liquidity4b_liq_1(i)] for i in range(1, N)]
queries['liquidity4a_nonliq'] = [[p_liquidity4a_nonliq_1(i)] for i in range(1, N)]


timeStart = time.time()
for prop in {'liquidity4b_liq','liquidity4a_nonliq'}:
    print()
    print('Property [' + prop + ']')
