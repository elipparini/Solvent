...
def pay(xa1, xn1, pay_amount, awNow, awNext, wNow, wNext, t_aw, t_w, block_num, oracleNow, oracleNext, t_oracle):
	...
	Not(pay_amount<=wNow), 
		...
		And(If(
	Not(pay_amount >= 0), 
		next_state_tx(awNow, awNext, wNow, wNext, oracleNow, oracleNext), And(send(xa1, pay_amount, wNow, t_w[0], awNow, t_aw[0]), next_state_tx(t_aw[0], awNext, t_w[0], wNext, oracleNow, oracleNext))),next_state_tx(t_aw[0], awNext, t_w[0], wNext, oracleNow, oracleNext))))))
...
def p_liquidity2a_liq_2(i):
    ...
    return And(
        Exists([xa_q], And(user_is_legit(xa_q), True,
            ForAll([xn_q0, f_q0, w_q0, *aw_q0, *t_w_q0, *t_awq_list0, block_num_q0, pay_amount_q0, oracle_q0, *t_oracle_q0, xn_q1, f_q1, w_q1, *aw_q1, *t_w_q1, *t_awq_list1, block_num_q1, pay_amount_q1, oracle_q1, *t_oracle_q1],  
                Or(
Not(step_trans(f_q0, xa_q, xn_q0, pay_amount_q0, aw[i], aw_q0, w[i], w_q0, t_aw_q0, t_w_q0, block_num[i], block_num_q0, i+0, oracle[i], oracle_q0, t_oracle_q0)),
...
def p_liquidity2a_liq_4(i):
    ...
    return And(
        Exists([xa_q], And(user_is_legit(xa_q), True,
            ForAll([xn_q0, f_q0, w_q0, *aw_q0, *t_w_q0, *t_awq_list0, block_num_q0, pay_amount_q0, oracle_q0, *t_oracle_q0, xn_q1, f_q1, w_q1, *aw_q1, *t_w_q1, *t_awq_list1, block_num_q1, pay_amount_q1, oracle_q1, *t_oracle_q1, xn_q2, f_q2, w_q2, *aw_q2, *t_w_q2, *t_awq_list2, block_num_q2, pay_amount_q2, oracle_q2, *t_oracle_q2, xn_q3, f_q3, w_q3, *aw_q3, *t_w_q3, *t_awq_list3, block_num_q3, pay_amount_q3, oracle_q3, *t_oracle_q3],  
                Or(
Not(step_trans(f_q0, xa_q, xn_q0, pay_amount_q0, aw[i], aw_q0, w[i], w_q0, t_aw_q0, t_w_q0, block_num[i], block_num_q0, i+0, oracle[i], oracle_q0, t_oracle_q0)),
Not(step_trans(f_q1, xa_q, xn_q1, pay_amount_q1, aw_q0, aw_q1, w_q0, w_q1, t_aw_q1, t_w_q1, block_num_q0, block_num_q1, i+1, oracle_q0, oracle_q1, t_oracle_q1)),
Not(step_trans(f_q2, xa_q, xn_q2, pay_amount_q2, aw_q1, aw_q2, w_q1, w_q2, t_aw_q2, t_w_q2, block_num_q1, block_num_q2, i+2, oracle_q1, oracle_q2, t_oracle_q2)),
...
def p_liquidity2a_liq_5(i):
    ...
    return And(
        Exists([xa_q], And(user_is_legit(xa_q), True,
            ForAll([xn_q0, f_q0, w_q0, *aw_q0, *t_w_q0, *t_awq_list0, block_num_q0, pay_amount_q0, oracle_q0, *t_oracle_q0, xn_q1, f_q1, w_q1, *aw_q1, *t_w_q1, *t_awq_list1, block_num_q1, pay_amount_q1, oracle_q1, *t_oracle_q1, xn_q2, f_q2, w_q2, *aw_q2, *t_w_q2, *t_awq_list2, block_num_q2, pay_amount_q2, oracle_q2, *t_oracle_q2, xn_q3, f_q3, w_q3, *aw_q3, *t_w_q3, *t_awq_list3, block_num_q3, pay_amount_q3, oracle_q3, *t_oracle_q3, xn_q4, f_q4, w_q4, *aw_q4, *t_w_q4, *t_awq_list4, block_num_q4, pay_amount_q4, oracle_q4, *t_oracle_q4],  
                Or(
Not(step_trans(f_q0, xa_q, xn_q0, pay_amount_q0, aw[i], aw_q0, w[i], w_q0, t_aw_q0, t_w_q0, block_num[i], block_num_q0, i+0, oracle[i], oracle_q0, t_oracle_q0)),
Not(step_trans(f_q1, xa_q, xn_q1, pay_amount_q1, aw_q0, aw_q1, w_q0, w_q1, t_aw_q1, t_w_q1, block_num_q0, block_num_q1, i+1, oracle_q0, oracle_q1, t_oracle_q1)),
Not(step_trans(f_q2, xa_q, xn_q2, pay_amount_q2, aw_q1, aw_q2, w_q1, w_q2, t_aw_q2, t_w_q2, block_num_q1, block_num_q2, i+2, oracle_q1, oracle_q2, t_oracle_q2)),
Not(step_trans(f_q3, xa_q, xn_q3, pay_amount_q3, aw_q2, aw_q3, w_q2, w_q3, t_aw_q3, t_w_q3, block_num_q2, block_num_q3, i+3, oracle_q2, oracle_q3, t_oracle_q3)),
Not(step_trans(f_q4, xa_q, xn_q4, pay_amount_q4, aw_q3, aw_q4, w_q3, w_q4, t_aw_q4, t_w_q4, block_num_q3, block_num_q4, i+4, oracle_q3, oracle_q4, t_oracle_q4)),
