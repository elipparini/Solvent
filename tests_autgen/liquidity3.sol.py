...
queries = {}
queries['liquidity3a_nonliq'] = [[p_liquidity3a_nonliq_1(i)] for i in range(1, N)]
queries['liquidity3b_liq'] = [[p_liquidity3b_liq_1(i)] for i in range(1, N)]


timeStart = time.time()
for prop in {'liquidity3a_nonliq','liquidity3b_liq'}:
    print()
    print('Property [' + prop + ']')
