...
def p_liquidity19a_liq_3(i):
    ...
    return And(
        Exists([xa_q], And(user_is_legit(xa_q), True,
            ForAll([xn_q0, f_q0, w_q0, *aw_q0, *t_w_q0, *t_awq_list0, block_num_q0, pay_amount_q0, xn_q1, f_q1, w_q1, *aw_q1, *t_w_q1, *t_awq_list1, block_num_q1, pay_amount_q1, xn_q2, f_q2, w_q2, *aw_q2, *t_w_q2, *t_awq_list2, block_num_q2, pay_amount_q2],  
                Or(
Not(step_trans(f_q0, xa_q, xn_q0, pay_amount_q0, aw[i], aw_q0, w[i], w_q0, t_aw_q0, t_w_q0, block_num[i], block_num_q0, i+0)),
Not(step_trans(f_q1, xa_q, xn_q1, pay_amount_q1, aw_q0, aw_q1, w_q0, w_q1, t_aw_q1, t_w_q1, block_num_q0, block_num_q1, i+1)),
...
def p_liquidity19a_liq_4(i):
    ...
    return And(
        Exists([xa_q], And(user_is_legit(xa_q), True,
            ForAll([xn_q0, f_q0, w_q0, *aw_q0, *t_w_q0, *t_awq_list0, block_num_q0, pay_amount_q0, xn_q1, f_q1, w_q1, *aw_q1, *t_w_q1, *t_awq_list1, block_num_q1, pay_amount_q1, xn_q2, f_q2, w_q2, *aw_q2, *t_w_q2, *t_awq_list2, block_num_q2, pay_amount_q2, xn_q3, f_q3, w_q3, *aw_q3, *t_w_q3, *t_awq_list3, block_num_q3, pay_amount_q3],  
                Or(
Not(step_trans(f_q0, xa_q, xn_q0, pay_amount_q0, aw[i], aw_q0, w[i], w_q0, t_aw_q0, t_w_q0, block_num[i], block_num_q0, i+0)),
Not(step_trans(f_q1, xa_q, xn_q1, pay_amount_q1, aw_q0, aw_q1, w_q0, w_q1, t_aw_q1, t_w_q1, block_num_q0, block_num_q1, i+1)),
Not(step_trans(f_q2, xa_q, xn_q2, pay_amount_q2, aw_q1, aw_q2, w_q1, w_q2, t_aw_q2, t_w_q2, block_num_q1, block_num_q2, i+2)),
...
queries = {}
queries['liquidity19a_liq'] = [[p_liquidity19a_liq_1(i),p_liquidity19a_liq_2(i),p_liquidity19a_liq_3(i),p_liquidity19a_liq_4(i),p_liquidity19a_liq_5(i)] for i in range(1, N)]


timeStart = time.time()
for prop in {'liquidity19a_liq'}:
    print()
    print('Property [' + prop + ']')
