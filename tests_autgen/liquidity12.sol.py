...
queries = {}
queries['liquidity12a_nonliq'] = [[p_liquidity12a_nonliq_1(i)] for i in range(1, N)]
queries['liquidity12b_nonliq'] = [[p_liquidity12b_nonliq_1(i)] for i in range(1, N)]


timeStart = time.time()
for prop in {'liquidity12a_nonliq','liquidity12b_nonliq'}:
    print()
    print('Property [' + prop + ']')
